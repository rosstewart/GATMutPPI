...
_MINT_SCRIPTS = Path(__file__).resolve().parent.parent
_BENCHMARK_DIR = Path("/home/rcstewart/ppi_lossgain/2026/mutppi/benchmark")

sys.path.insert(0, str(_MINT_SCRIPTS))
...
_GCV_CACHE    = Path("/data/ross/ppi_lossgain/interaction_loss/nm_revisions/mint_cache.pkl")
